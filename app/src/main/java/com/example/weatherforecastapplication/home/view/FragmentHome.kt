           ...
           lifecycleScope.launch {
               ...
               viewModel.uiState.collectLatest { uiState ->when (uiState) {
                   ...
                   is ApiState.Success -> {
                       ...
                       binding.textViewCityNameHome.text=it.address.toString()
                       Log.i(TAG, "///////////////////test: ${it.address.toString()}")
...
//                    println("/////sunset Time:  ${ SimpleDateFormat("hh:mm a", Locale.ENGLISH).format(sunset)}")
                   ...
                   is ApiState.Loading->{
                       ...
                       Log.i(TAG, "////////////////////ttteeessstttt: ${it.latitude} ${it.longtude} ${it.address}")
...
//                   val lat=viewModel.latitude  !!
               viewModel.allWeatherNetwork(it.longtude.toString(),it.latitude.toString(),"",unit,language)
           }
